...
class Spectrum {
 public:
  ...
  inline Spectrum operator^(double x) const {
	  return Spectrum(pow(r, x), pow(g, x), pow(b, x));
  }
  ...
  //inline Spectrum operator+(float o) const {
	 // return Spectrum(r + o, g + o, b + o);
  //}

  //inline Spectrum operator+(double o) const {
	 // return Spectrum(r + o, g + o, b + o);
  //}
